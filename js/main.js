...
mit.main = function() {
  ...
  */
  ...
  tweet.href='http://weibo.com/hanrenxuan';

  var facebook = document.getElementById("fb");
  facebook.href='http://52mayday.cn/';
  ...
  try {
    ...
    if (mit.highScore)
      ui.high_score.text("最高得分: "+ mit.highScore);
  ...
  */
  mit.gameOver = function() {
    ...
    if (mit.score > mit.highScore) {
      ...
      localStorage.setItem("最高得分", JSON.stringify(parseInt(mit.score)));

      ui.high_score.text("最高得分: "+ mit.highScore);
    }

    // Show last_score
    ui.last_score.text("最后比分: " + parseInt(mit.score));


    ui.start_game.html('重新开始');
    ui.tweet.html('微博');
    ui.fb.html('主页');
    ...
    // Share
    var tweet = document.getElementById("tweet");
    tweet.href='http://weibo.com/u/5753991834';
  
    var facebook = document.getElementById("fb");
    facebook.href='http://so.jutuit.com/yy.html';
